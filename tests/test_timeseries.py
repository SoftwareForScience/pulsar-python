...
class TestTimeseries(unittest.TestCase):
    ...
    def test_downsample_length(self):
        ...
        downsamples_arr = Timeseries(timeseries_array).downsample(downsample_rate_q)

        self.assertEqual(len(downsamples_arr), math.ceil(len(timeseries_array) / downsample_rate_q))
